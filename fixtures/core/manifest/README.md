...
- `invalid-cases.json` defines representative strict-YAML and schema failures with their complete expected diagnostics, including messages, paths, pointers, scalar ranges, entities, normalized details, ordering, and source.
