...
These fixtures exercise the initial `typescript-responses-api-7` target through the real Core adapter boundary and `@moldea.ai/repository/memory`.

- `cases.json` owns one complete supported direct OpenAI Responses integration.
