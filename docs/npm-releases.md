...
5. Repeat for the remaining initial packages in dependency order:
   ...
   11. `@moldea.ai/adapter-vercel-ai-sdk`
   12. `@moldea.ai/cli`
   13. `@moldea.ai/website-ui`
