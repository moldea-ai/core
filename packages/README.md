...
`@moldea.ai/adapter-static-analysis` owns the provider-neutral text, package-discovery, TypeScript binding, request-call, relationship-closure, and immutable-array primitives shared by the Anthropic and OpenAI adapters. Provider evidence and diagnostics remain owned by each public adapter.
