...
const runRuntimeCompatibilityCheck = async (artifactDirectory) => {
  ...
  try {
    ...
    assertRuntimeInvariant(cliManifest?.version === '3.1.1', 'The CLI version is invalid.');
    ...
    assertRuntimeInvariant(versionResult.stdout === '3.1.1\n', 'The version output is invalid.');
    ...
    assertRuntimeInvariant(
      compatibilityEnvelope.cliVersion === '3.1.1' &&
