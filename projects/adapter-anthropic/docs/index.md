...
The package is available. Its only current compatibility target is **experimental**, not production-ready support: TypeScript ESM using direct Anthropic Messages API calls with npm `@anthropic-ai/sdk >=0.117.1 <0.118.0`, Repository Format version `1`, and compatible Core `^2.0.0`.
