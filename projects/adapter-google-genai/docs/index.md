...
The package is available with one experimental target: TypeScript ESM using direct `models.generateContent` calls with npm `@google/genai >=2.17.1 <3.0.0`, Repository Format version `1`, and Core `^2.0.0`.
