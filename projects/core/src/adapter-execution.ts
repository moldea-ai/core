...
import type { IFrameworkAdapterContext, IFrameworkAdapterEvidence } from './adapter.js';
import type { IMoldeaProjectIndex } from './contracts.js';
import {
  normalizeFrameworkAdapterEvidence,
  validateFrameworkAdapterResult,
} from './adapter-validation.js';
import { normalizeDiagnostics } from './diagnostic-utilities.js';
...
import type { ICoreOptionsSnapshot, IFrameworkAdapterSnapshot } from './options.js';
